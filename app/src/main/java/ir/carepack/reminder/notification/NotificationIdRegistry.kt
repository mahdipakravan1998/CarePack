...
class Sha256NotificationIdCandidateSource :
    NotificationIdCandidateSource {
...
class PersistentNotificationIdRegistry(
    ...
    override fun idFor(
        ...
        synchronized(this) {
            ...
            val forwardKey =
                forwardKey(namespace, stableKey)
            ...
            val initialCandidate =
                candidateSource
                    .candidate(namespace, stableKey)
                    .coerceIn(MIN_ID, MAX_ID)
            ...
            repeat(MAX_PROBE_COUNT) {
                ...
                val owner =
                    preferences.getString(reverseKey, null)
                val expectedOwner =
                    "$namespace\u001f$stableKey"
                ...
                if (owner == null || owner == expectedOwner) {
                    val committed =
                        preferences
                            .edit()
                            .putInt(forwardKey, candidate)
                            .putString(reverseKey, expectedOwner)
                            .commit()
    ...
    override fun findExistingId(
        ...
        synchronized(this) {
            ...
            preferences.getInt(key, INVALID_ID)
    ...
    override fun forget(
        ...
        synchronized(this) {
            val persistedId =
                findExistingId(namespace, stableKey)
            ...
            val committed =
                preferences.edit()
                    .remove(forwardKey(namespace, stableKey))
                    .remove(reverseKey)
                    .commit()
            check(committed)
            true
    ...
    private fun forwardKey(
        ...
        "forward:$namespace:${stableKey.length}:$stableKey"

    private fun reverseKey(id: Int): String =
        "reverse:$id"
