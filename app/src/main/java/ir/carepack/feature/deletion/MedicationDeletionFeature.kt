...
data class MedicationDeletionUiState(
    ...
    val deletionFailureStage:
    MedicationDeletionStage? = null,
    val databaseDeletedAfterFailure:
    Boolean = false,
...
class MedicationDeletionViewModel(
    ...
    fun loadPreview() {
        ...
        viewModelScope.launch {
            ...
            when (result) {
                is MedicationDeletionPreviewResult
                .Available -> {
                    mutableState.update { current ->
                        current.copy(
                            isLoading = false,
        ...
        Column(
            ...
            Text(
                text =
                    stringResource(
                        R.string
                            .medication_deletion_preview_failed,
                    ),
                color =
                    MaterialTheme
                        .colorScheme
...
private fun MedicationDeletionContent(
        ...
        Column(
            ...
            Text(
                text =
                    stringResource(
                        R.string
                            .medication_deletion_warning_title,
                    ),
                style =
                    MaterialTheme
                        .typography
                ...
                text =
                    stringResource(
                        if (experience.isSimple) {
                            R.string
                                .medication_deletion_warning_body_simple
                        } else {
                            R.string
                                .medication_deletion_warning_body
                        },
                    ),
            )
        }
    ...
    Text(
        text =
            stringResource(
                R.string
                    .medication_deletion_impact_title,
            ),
        style =
            MaterialTheme
                .typography
        ...
        Column(
            ...
            ImpactCountRow(
                label =
                    stringResource(
                        R.string
                            .medication_deletion_report_count,
                    ),
                count =
                    ...
                    text =
                        stringResource(
                            if (
                                ...
                                R.string
                                    .medication_deletion_cleanup_failed
                            } else {
                                R.string
                                    .medication_deletion_failed
                            },
                        ),
                    color =
                        MaterialTheme
